...
def settings(param=[]):
    ...
    parser.add_argument('--lam_t', type=float, default=0.05, help="loss lambda time")
    parser.add_argument('--lam_c', type=float, default=1, help="loss lambda category")
    parser.add_argument('--lam_s', type=float, default=0.5, help="loss lambda for geographcal consistency")
    # model params
    # embedding
